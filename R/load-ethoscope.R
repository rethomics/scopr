...
#' When `NULL` and if `FUN` is set, columns can be retreived automatically (from the attributes of `FUN`).
#' @param cache the name of a local directory to cache results for faster subsequent data loading.
#' @param ncores number of cores to use for optionnal parallel processing (experimental).
